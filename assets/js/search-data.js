...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "publications",
          description: "how to add For a full list of my publications, please visit my [Google Scholar profile](https://scholar.google.com/citations?user=1-wpavIAAAAJ&amp;hl=en).",
          section: "Navigation",
          handler: () => {
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-i-successfully-defended-my-dissertation-titled-validating-dna-metabarcoding-for-characterization-of-pollen-from-surface-soils",
          title: 'I successfully defended my dissertation titled “Validating DNA Metabarcoding for Characterization of Pollen...',
          description: "",
